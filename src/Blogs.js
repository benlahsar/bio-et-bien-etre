...
const BlogPosts = [
    ...
    {
        id: 2,
        title: "Zit Pikalat Nizar",
        date: "2024-10-31",
        summary: "Huilw dw Sesame.",
    ...
    {
        id: 4,
        title: "Huile Oued Sousse",
        date: "2024-11-01",
        summary: "100 ML Huile d'argane.",
        image: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRdp4CxTnCmTTWt0FryCynNqBbsCTUVOwj9Mw&s",
        link: "https://ofppt.ma/" // Ajoutez l'URL ici
    },
    {
        id: 5,
        title: "REVOX",
                    ...
                    <SectionCat>
                        <ul style={{ listStyle: 'none', padding: 0 }}>
                            {Categories.map(categorie => (
                                <li key={categorie.id}>
                                    <h3><div dangerouslySetInnerHTML={{ __html: categorie.link }}  /></h3>
                                </li>
                            ))}
                        </ul>
                    </SectionCat>
